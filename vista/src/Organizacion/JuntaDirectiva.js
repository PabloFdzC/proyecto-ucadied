...
import ConfirmaEliminar from '../Utilidades/ConfirmaEliminar';
...
class JuntaDirectiva extends React.Component {
    ...
    */
    ...
    a ConfirmaEliminar para el puesto o para el miembro
    Parámetros:
    - nombre: string (pueden ser los valores Puesto, Miembro o
        Usuario),
    - muestra: booleano para saber si se muestra o se cierra el
                ...
                {({usuario, organizacion})=>{
                    if(usuario.tipo === "Administrador" || usuario.tipo === "Usuario"){
                        return (<>
                            ...
                            <Modal.Body>
                                <ConfirmaEliminar titulo={"¿Desea eliminar a "+this.state.Miembro.nombre+" de la Junta Directiva?"} eliminar={this.eliminarMiembro} cerrarModal={()=>this.muestraModalEliminar("Puesto",false)} />
                            </Modal.Body>
                            </Modal>
                            <Modal show={this.state.muestraEliminarPuesto} onHide={()=>this.muestraModalEliminar("Puesto",false)} className="modal-green">
                            <Modal.Body>
                                <ConfirmaEliminar titulo={"¿Desea eliminar el puesto de "+this.state.Puesto.nombre+"?"} eliminar={this.eliminarPuesto} cerrarModal={()=>this.muestraModalEliminar("Miembro",false)} />
                            </Modal.Body>
                            </Modal>
                            </>);
                    } else {
